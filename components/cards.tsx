...
const FeaturedCard = ({onPress,item}:Props) => {
      return (
...
const Card = ({onPress,item}:Props) => {
      return (
          <TouchableOpacity onPress={onPress} className='flex-1 w-full mt-4 px-3 py-4 rounded-lg bg-white shadow-lg shadow-black-100/70 relative'>
                <View className='flex-row items-center px-2 bg-white/90 p-1 rounded-full absolute z-50 top-5 right-5'>
                ...
                <View className='flex-col mt-2 '>
                      ...
                      <Text className='text-base font-rubik text-black-200'>{item.address}</Text>
